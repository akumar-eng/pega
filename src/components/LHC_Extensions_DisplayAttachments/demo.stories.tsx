...
import { LHCExtensionsDisplayAttachments, type UtilityListProps } from './index';

export default {
  title: 'Widgets/LHC Display Attachments',
  argTypes: {
    dataPage: {
      table: {
        disable: true
  ...
  component: LHCExtensionsDisplayAttachments
};
...
type Story = StoryObj<typeof LHCExtensionsDisplayAttachments>;
...
const DisplayAttachmentsDemo = (inputs: UtilityListProps) => {
  return {
    render: (args: UtilityListProps) => {
      ...
      return <LHCExtensionsDisplayAttachments {...props} />;
    },
    args: inputs
  };
};
